...
<body>
    <div id="root">
        <div id="main">
            ...
            <div id="new-sub">
                <img alt="첫 구독 시 2주 무료!" src="./images/subscription_ticket.png" class="new-sub-ticket">
            ...
            <nav id="main-navigation">
                <a class="logo-link" href="#/">
                    <img alt="Watcha" src="./images/logo.svg" class="logo">
                </a>
                            ...
                            <div class="profile-area-in">
                                <button class="accountAndSettings" type="button">
                                    <figure id="profile-picture" class="profile-picture">
                                        <img alt="" src="./images/profile_image.jpg" class="profile-picture-image">
                                    </figure>
                                </button>
                            </div>
