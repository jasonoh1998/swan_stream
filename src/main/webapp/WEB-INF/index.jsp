...
<head>
    ...
    <link rel="stylesheet" href="/swan_stream/styles/pay.css">
	...
	<script type="text/javascript" src="/swan_stream/js/pay.js" defer></script>
...
<body>
    ...
    <div class="modal-um">
        <div class="modal">
            ...
            <div class="css-191trr8">
                ...
                <div class="css-ty0gcz">
                    <button type="button" class="css-z6cg4t two-btn">2주 무료 이용 시작</button>
                </div>
            </div>
        </div><!-- modal 프리미엄 요금제 화면 -->

        <!-- modal 뒤에 깔리는 main 화면임-->
        <div class="modal-main">
            <button class="btn-open-popup txt1" style="margin-bottom: 15px;">무료 이용 시작 누르기</button><br>
            <button class="btn-open-popup2 txt1" style="margin-bottom: 15px;">프리미엄</button><br>
            <button button class="btn-open-popup3 txt1">베이직</button>
        </div>
        ...
        <!-- <div class="modal3"> 원래 modal3인데 와챠 따라가보자 -->
        <div class="modal3">
            <div class="css-191trr8">
                <button class=" x-btn css-fnpq01-CloseButton"></button>
                ...
                <div class="css-ty0gcz">
                    <button class="css-z6cg4t two-btn2">2주 무료 이용 시작</button>
                </div>
            </div>
        </div><!-- modal3 베이직 요금제 화면 끝 -->
                                        ...
                                        <div class="css-1qk9bkt">
                                            <div>
                                                ...
                                                <label class="css-1a6fw58">
                                                    ...
                                                    <div class="css-0">
                                                        <div class="css-k5snl0">
                                                            <input name="rrn" class="css-7lsjjs" id="rrn" type="text"
                                                                value>
                                                        </div>
                                                    </div>
                                                </label>
                        ...
                        <section class="css-9j37xe-CardFormSection">
                            <form class="css-11zhy3w" action="">
                                <div class="css-10kc5g1">
                                    ...
                                    <li class="css-1t5l6f">
                                        <label for="card" class="css-rdv6g1 bago-btn4 ">
                                            <div style="width: 16px; height: 16px;">
                                                <input type="radio" id="card" name="paymentMethod" class="css-nw450d"
                                                    value="card" checked>
                                                <span size="16" class="css-55n3ab">
                        ...
                        <section class="css-9j37xe-CardFormSection">
                            <form class="css-11zhy3w" action="">
                                <div class="css-10kc5g1">
                                    ...
                                    <li class="css-1t5l6f">
                                        <label for="card" class="css-rdv6g1 bago-btn7 ">
                                            <div style="width: 16px; height: 16px;">
                                                <input type="radio" id="card" name="paymentMethod" class="css-nw450d"
                                                    value="card" checked>
                                                <span size="16" class="css-55n3ab">
                        ...
                        <section class="css-9j37xe-CardFormSection">
                            <form class="css-11zhy3w" action="">
                                <div class="css-10kc5g1">
                                    ...
                                    <li class="css-1t5l6f">
                                        <label for="card" class="css-rdv6g1 bago-btn10 ">
                                            <div style="width: 16px; height: 16px;">
                                                <input type="radio" id="card" name="paymentMethod" class="css-nw450d"
                                                    value="card" checked>
                                                <span size="16" class="css-55n3ab">
                        ...
                        <section class="css-9j37xe-CardFormSection">
                            <form class="css-11zhy3w" action="">
                                <div class="css-10kc5g1">
                                    ...
                                    <li class="css-1t5l6f">
                                        <label for="card" class="css-rdv6g1 bago-btn41">
                                            <div style="width: 16px; height: 16px;">
                                                <input type="radio" id="card" name="paymentMethod" class="css-nw450d"
                                                    value="card" checked>
                                                <span size="16" class="css-55n3ab">
        ...
        <div class="pay-info">
            ...
            <div class="payinfo-body">
                ...
                <div class="css-tqtwi4">
                    <button class="css-1o9f1nz">알겠어요</button>
                </div>
            </div>
